...
class ActionableRecommendation(BaseModel):
    ...
    impacted_metrics: List[str] = Field(..., description="Metrics addressed, e.g., ['soil_ph', 'soil_organic_carbon']")
    time_horizon: str = Field(..., description="Implementation timeframe: short-term, medium-term, or long-term")
    citations: List[CitationSchema] = Field(..., description="Exact references to grounded evidence chunks used")
